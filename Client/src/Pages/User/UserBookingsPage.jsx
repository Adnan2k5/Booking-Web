...
import { Calendar, MapPin, Star, User, Loader2, ChevronLeft, ChevronRight, CreditCard, Clock, Users, FileText, Hotel, Package, Activity } from "lucide-react"
...
const UserBookings = () => {
    ...
    const fetchBookings = async (type = "sessions", page = 1) => {
        try {
            ...
            setError(prev => ({ ...prev, [type]: `Failed to fetch ${type} bookings` }))
        ...
        if (!currentBookings.length) {
            return (
                <div className="text-center py-8">
                    ...
                    <p className="text-gray-400">Book your first {type === 'sessions' ? 'adventure' : type.slice(0, -1)} to see it here!</p>
                </div>
            )
        }
                        ...
                        <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                            <div>
                                <p className="text-sm text-gray-700">
                                    ...
                                    of{' '}
                                    <span className="font-medium">{currentPagination.total}</span> results
                                </p>
                            </div>
                            <div>

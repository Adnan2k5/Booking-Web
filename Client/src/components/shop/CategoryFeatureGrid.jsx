        ...
        {featureData.map((f, i) => (
          <div key={i} className="group relative h-[260px] md:h-[300px] overflow-hidden rounded-xl">
            ...
            <div className="relative z-10 h-full flex flex-col justify-end p-8">
              ...
              <Button className="bg-white text-black hover:bg-orange-500 hover:text-white rounded-full h-9 px-5 text-xs font-semibold tracking-wide w-fit translate-y-3 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                Shop Now
              </Button>
            </div>
          </div>

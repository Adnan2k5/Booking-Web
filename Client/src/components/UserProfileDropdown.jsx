    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger asChild>
                <motion.button className="focus:outline-none" whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
            ...
            <DropdownMenuContent align="end" className="w-56">
                <DropdownMenuLabel className="flex flex-col">
                    ...
                    <div className="flex items-center mt-1">
                        ...
                        <Badge className={`ml-1 ${getLevelColor()} text-white`}>{getUserLevel()}</Badge>
                    </div>
                </DropdownMenuLabel>
                ...
                <div className="px-2 py-1.5">
                    <div className="w-full bg-gray-200 rounded-full h-2">
                        <div
                            ...
                            style={{ width: `${Math.min((user.bookings?.length || 0) * 5, 100)}%` }}
                        ></div>
                    </div>
                </div>

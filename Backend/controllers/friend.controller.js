...
export const searchByEmailId = asyncHandler(async (req, res) => {
    ...
    const user = await User.findOne({ email }).select("name email profilePicture _id");
    ...
    return res.status(200).json(
        new ApiResponse(200, {
            ...
            requestStatus: existingRequest ? {
                isSentByMe: existingRequest.sender.toString() === req.user._id.toString(),
...
export const acceptFriendRequest = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, populatedRequest, "Friend request accepted successfully")
    );
});
export const rejectFriendRequest = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, populatedRequest, "Friend request rejected successfully")
    );
});
export const getFriendRequests = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, friendRequests, "Friend requests retrieved successfully")
    );
});
